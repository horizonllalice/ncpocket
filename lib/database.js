  ...
  try {
    const { data, error } = await supabase
      ...
      .upsert({
        ...
        needs_percentage: settings.needs,
        wants_percentage: settings.wants,
        savings_percentage: settings.savings,
        income_goal: settings.income_goal,
...
export async function addFixedExpenseCategory(name, goalAmount = 0) {
  if (!isSupabaseAvailable()) {
    console.warn('Supabase not available, skipping fixed expense category addition')
    return null
  }
...
export async function updateFixedExpenseCategory(id, updates) {
  if (!isSupabaseAvailable()) {
    console.warn('Supabase not available, skipping fixed expense category update')
    return null
  }
...
export async function deleteFixedExpenseCategory(id) {
  if (!isSupabaseAvailable()) {
    console.warn('Supabase not available, skipping fixed expense category deletion')
    return null
  }
...
export async function addFixedExpenseSubitem(categoryId, name, goalAmount = 0) {
  if (!isSupabaseAvailable()) {
    console.warn('Supabase not available, skipping fixed expense subitem addition')
    return null
  }
...
export async function updateFixedExpenseSubitem(id, updates) {
  if (!isSupabaseAvailable()) {
    console.warn('Supabase not available, skipping fixed expense subitem update')
    return null
  }
...
export async function deleteFixedExpenseSubitem(id) {
  if (!isSupabaseAvailable()) {
    console.warn('Supabase not available, skipping fixed expense subitem deletion')
    return null
  }
...
export async function addFixedExpenseTransaction(categoryId, amount, description = '', subitemId = null) {
  if (!isSupabaseAvailable()) {
    console.warn('Supabase not available, skipping fixed expense transaction addition')
    return null
  }
...
export async function addVariableExpenses(expenses) {
  if (!isSupabaseAvailable()) {
    console.warn('Supabase not available, skipping variable expenses addition')
    return null
  }
...
export async function addWantsTransaction(amount, description = '') {
  if (!isSupabaseAvailable()) {
    console.warn('Supabase not available, skipping wants transaction addition')
    return null
  }
...
export async function addSavingsTransaction(amount, description = '') {
  if (!isSupabaseAvailable()) {
    console.warn('Supabase not available, skipping savings transaction addition')
    return null
  }
...
export async function addDailyFoodTransaction(amount, description = '') {
  if (!isSupabaseAvailable()) {
    console.warn('Supabase not available, skipping daily food transaction addition')
    return null
  }
...
export async function resetIncomeRecords() {
  if (!isSupabaseAvailable()) {
    console.warn('Supabase not available, skipping income records reset')
    return null
  }
...
export async function resetWantsTransactions() {
  if (!isSupabaseAvailable()) {
    console.warn('Supabase not available, skipping wants transactions reset')
    return null
  }
...
export async function resetSavingsTransactions() {
  if (!isSupabaseAvailable()) {
    console.warn('Supabase not available, skipping savings transactions reset')
    return null
  }
...
export async function resetDailyFoodTransactions() {
  if (!isSupabaseAvailable()) {
    console.warn('Supabase not available, skipping daily food transactions reset')
    return null
  }
...
export async function resetFixedExpenseTransactions() {
  if (!isSupabaseAvailable()) {
    console.warn('Supabase not available, skipping fixed expense transactions reset')
    return null
  }
...
export async function resetVariableExpenses() {
  if (!isSupabaseAvailable()) {
    console.warn('Supabase not available, skipping variable expenses reset')
    return null
  }
